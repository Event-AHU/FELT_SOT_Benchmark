...
* [2024.03.09] Our arXiv paper is available at [[arXiv](https://arxiv.org/pdf/2403.05839v2)]. 
...
## Framework 
<p align="center">
<img src="https://github.com/Event-AHU/FELT_SOT_Benchmark/blob/main/AMTTrack_v1/figures/framework.jpg" alt="framework" width="700"/>
</p>
...
* **[Note]** If you need the event voxel, please use the script [[event_to_voxel_felt.py](https://github.com/Event-AHU/FELT_SOT_Benchmark/blob/main/AMTTrack_v1/event_to_voxel_felt.py)] to transform the event point for the voxel. For the construction of baseline trackers (from RGB tracker to RGB-event tracker) to compare, in this benchmark, we fuse the RGB frame and event data using the script [[fusion_rgb_event_image.py](https://github.com/Event-AHU/FELT_SOT_Benchmark/blob/main/AMTTrack_v1/fusion_rgb_event_image.py)]. Please check them for more detailed information.
...
<p align="center">
<img src="https://github.com/Event-AHU/FELT_SOT_Benchmark/blob/main/AMTTrack_v1/figures/felt_sot_samples.jpg" alt="felt_sot_samples" width="700"/>
</p>
...
<p align="center">
<img src="https://github.com/Event-AHU/FELT_SOT_Benchmark/blob/main/AMTTrack_v1/figures/FELT_results.jpg" alt="framework" width="900"/>
</p>
