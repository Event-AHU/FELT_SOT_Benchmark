...
class COESOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        # return Sequence(sequence_name, aps_frame_list, 'COESOT', ground_truth_rect)  # rgb
        # return Sequence(sequence_name, dvs_frame_list, 'COESOT', ground_truth_rect)  # event
        # return Sequence(sequence_name, stack_frame_list, 'COESOT', ground_truth_rect)  # stack
        return Sequence(sequence_name, aps_frame_list, 'COESOT', ground_truth_rect, dvs_frame_list=dvs_frame_list)  # rgb + event
        # return Sequence(sequence_name, aps_frame_list, 'COESOT', ground_truth_rect, event_voxel_list=event_voxel_list)  # rgb + event_voxel
        # return Sequence(sequence_name, aps_frame_list, 'COESOT', ground_truth_rect, dvs_frame_list=dvs_frame_list, event_voxel_list=event_voxel_list)  # rgb + event + event_voxel