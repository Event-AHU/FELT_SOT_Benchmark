...
class Tracker:
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        #################################################################
        # THOR info
        st_update_count, lt_update_count, frame_count = tracker.get_update_count()
        print(f'THOR info: update_count: {st_update_count} / {lt_update_count} / {frame_count}')

        sample_count, frame_count = tracker.get_sample_count()
        print(f'THOR info: sample_count: {sample_count} / {frame_count}')
        #################################################################
