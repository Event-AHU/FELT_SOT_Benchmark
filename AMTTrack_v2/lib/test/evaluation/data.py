...
class Sequence:
    ...
    def __init__(self, name, aps_frame_list, dataset, ground_truth_rect, ground_truth_seg=None, init_data=None,
                ...
                #  frame_event_list=None, event_img_list=None):
                 dvs_frame_list=None, event_voxel_list=None):
        self.name = name
        self.aps_frame_list = aps_frame_list  # rgb
        self.dvs_frame_list = dvs_frame_list  # event
        self.event_voxel_list = event_voxel_list  # event_voxel
