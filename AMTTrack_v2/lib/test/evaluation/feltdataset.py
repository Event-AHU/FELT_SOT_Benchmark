...
class FELTDataset(BaseDataset):
    ...
    def _get_sequence_list(self, split):
        ...
        # with open('/wangx/DATA/Code/louxufeng/My_Tracking/CeaTrack_v29/lib/test/txt/list_my.txt') as f:
    ...
    def _construct_sequence(self, sequence_name):
        ...
        # return Sequence(sequence_name, aps_frame_list, 'FELT', ground_truth_rect)  # rgb
        # return Sequence(sequence_name, dvs_frame_list, 'FELT', ground_truth_rect)  # event
        # return Sequence(sequence_name, stack_frame_list, 'FELT', ground_truth_rect)  # stack
        return Sequence(sequence_name, aps_frame_list, 'FELT', ground_truth_rect, dvs_frame_list=dvs_frame_list)  # rgb + event
        # return Sequence(sequence_name, aps_frame_list, 'FELT', ground_truth_rect, event_voxel_list=event_voxel_list)  # rgb + event_voxel
        # return Sequence(sequence_name, aps_frame_list, 'FELT', ground_truth_rect, dvs_frame_list=dvs_frame_list, event_voxel_list=event_voxel_list)  # rgb + event + event_voxel