...
class CEBlock(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.hopufield = HopfieldLayer(dim, n_prototype=1000, dropout=0.1)
    ...
    def forward(self, x, global_index_template, global_index_search, mask=None, ce_template_mask=None, keep_ratio_search=None, i=None):
        if i < 8:
            x = self.hopufield(x) + x
